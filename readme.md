...
6.  **Application Live:** The web application is now accessible via the public IP address of the EC2 instance. Below live image depicted the live demonstration screenshoot of the web application.
